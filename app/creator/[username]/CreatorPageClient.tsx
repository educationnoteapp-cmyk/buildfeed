...
export default function CreatorPageClient({ creator, posts, isFollowing }: CreatorPageClientProps) {
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-start gap-5 mb-8">
          ...
          <div className="flex flex-col items-end gap-3 flex-shrink-0">
            <FollowButtonWrapper targetId={creator.id} type="creator" initialIsFollowing={isFollowing} />
            <div className="flex gap-4 text-center">
              <div>
                <p className="text-lg font-bold text-text-main">{posts.length}</p>
