    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-muted text-sm mb-8 leading-relaxed">
          הדף שחיפשת לא קיים, הועבר, או שהלינק שבור.
          <br />
          הנה כמה מקומות שכנראה כן קיימים:
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/studio"
            className="bg-surface border border-border hover:border-white/20 text-text-main font-medium px-5 py-2.5 rounded-xl transition-colors text-sm">
            Studio שלי
          </Link>
        </div>
